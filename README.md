...
Pagination is used to load more commits, and the application redirects to a `does not exist` page (`/does/not/exist`) when the given repo does not exist or the user navigates to an invalid URL.
